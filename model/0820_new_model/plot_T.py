...
time = [5, 10, 15, 20, 30, 60]
coverage = {}
coverage['1050'] = (time, [0.5718, 0.824, 0.9665, 0.9862, 1, 1])
coverage['1025'] = (time, [0.4875, 0.6845, 0.8752, 0.9342, 0.9912, 1])
coverage['1000'] = (time, [0.172, 0.5307, 0.6911, 0.817, 0.8735, 0.9897])
coverage['950'] =  (time, [0.1085, 0.2629, 0.4527, 0.5409, 0.6104, 0.8266])
coverage['900'] =  (time, [0.072, 0.1208, 0.131, 0.1382, 0.1942, 0.3542])
# plot results
fig = plt.figure()
