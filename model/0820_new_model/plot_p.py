...
y0 = [0, 0, 0, 0, 0, 0, 1*Config.nd]
sigma = 1 # affect nucleation density
para = (sigma, Config.decay_rate)
...
for c in c_ch4:
    ...
    para = (sigma, Config.decay_rate)
    sol.append( odeint(f_rate_2, y0, t, args=(para,), mxstep=10000, atol=1e-8, rtol=1e-6) )
# plot results
fig = plt.figure()
